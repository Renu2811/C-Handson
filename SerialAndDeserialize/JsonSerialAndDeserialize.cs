...
{
    public class JsonSerialAndDeserialize
    {
            public class EBBill
            {
            ...
            public void JsonSerialize()
            {
                ...
                FileStream fileStream = new FileStream(@"D:\C#handson\SerialAndDeserialize\JsonFile.txt", FileMode.Create);
            ...
            {
                EBBill eBBill;
                FileStream fileStream = new FileStream(@"D:\C#handson\SerialAndDeserialize\JsonFile.txt", FileMode.Open);
                JsonSerializer jsonSerializer = new JsonSerializer();
