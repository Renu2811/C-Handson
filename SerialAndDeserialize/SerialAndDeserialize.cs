...
namespace SerialAndDeserialize
{
    ...
    { 
            ...
            public void Serialize()
            {
                ...
                FileStream fileStream = new FileStream(@"D:\C#handson\SerialAndDeserialize\XmlFile.txt", FileMode.Create);
            ...
            {
                FileStream fileStream = new FileStream(@"D:\C#handson\SerialAndDeserialize\XmlFile.txt", FileMode.Open);
                XmlSerializer xmlSerializer = new XmlSerializer(typeof(List<EBBill>));
